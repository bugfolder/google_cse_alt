This is a customized version of the Google Custom Search Engine module of the
same name, modified for the OrigamiUSA website. We change the render array for
the search block for Bootstrap compatibility and we make changes that support
the use of multiple search engines within the same site, so that we can offer
both site-wide and SOURCE-specific search engines on different pages.
...
Place the google_cse_alt directory in your sites/all/modules directory.
...
Drupal version authored and maintained by mfb: http://drupal.org/user/12302
...
queue at http://backdrop.org/project/issues/google_cse_alt
